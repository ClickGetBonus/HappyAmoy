...
#warning 修改位置
    CGFloat YMinRetangle = self.frame.size.height / 2.0 - sizeRetangle.height/2.0 - 50;
...
//    CGContextSetStrokeColorWithColor(context, [UIColor colorWithRed:0.110 green:0.659 blue:0.894 alpha:1.00].CGColor);
    CGContextSetStrokeColorWithColor(context, [UIColor colorWithRed:227 / 255.0 green:62 / 255.0 blue:9 / 255.0 alpha:1.00].CGColor);

    CGContextSetRGBFillColor(context, 1.0, 1.0, 1.0, 1.0);
#warning 修改颜色

//    CGContextSetRGBFillColor(context, 227 / 255.0, 227 / 255.0, 62 / 255.0, 9 / 255.0);

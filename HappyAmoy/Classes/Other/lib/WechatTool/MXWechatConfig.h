...
#define MXWechatAPPID       @"wxa6625e145fcd329a"
// 开放平台登录https://open.weixin.qq.com的开发者中心获取AppSecret。
#define MXWechatAPPSecret   @"950087527b49e34831f84ef5aad270af"
// 微信支付商户号
#define MXWechatMCHID       @"1512676921"
// 安全校验码（MD5）密钥，商户平台登录账户和密码登录http://pay.weixin.qq.com
// 平台设置的“API密钥”，为了安全，请设置为以数字和字母组成的32字符串。
#define MXWechatPartnerKey  @"haomai527b49e34831f84ef5aad270af"

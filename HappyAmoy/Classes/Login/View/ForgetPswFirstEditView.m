...
@interface ForgetPswFirstEditView ()
...
@implementation ForgetPswFirstEditView
...
//    getMsgCodeButton.backgroundColor = QHMainColor;
...
//            [weakSelf.getMsgCodeButton setBackgroundColor:RGB(227, 62, 9)];
